...
public class CurrentUserTask extends AsyncTask<String, Void, CurrentUserTaskResponse> {

    private String userId;
    private String secret;

    public CurrentUserTask(String userId, String secret) {
        this.userId = userId;
        this.secret = secret;
    }
    ...
    protected CurrentUserTaskResponse doInBackground(String... strings) {
        GetRequest getRequest = new GetRequest(WuerschURLs.getCurrentUserPath(), true, userId, secret);
